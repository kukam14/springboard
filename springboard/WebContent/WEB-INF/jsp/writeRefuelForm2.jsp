...
<head>
    ...
    <!-- Bootstrap -->
    <link href="/springboard/css/bootstrap.min.css" rel="stylesheet">
...
<!-- 
<body>
    <form class="form" name="refuelFrm" action="writeRefuel.do" method="post">
...
<form name="refuelFrm" action="writeRefuel2.do" method="post">
<tr>
